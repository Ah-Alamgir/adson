...
public final class NiceCountDownTimer {
    ...
    public NiceCountDownTimer(long fromMinutes, long fromSeconds, long delayInSeconds, OnCountDownListener onCountDownListener) {
